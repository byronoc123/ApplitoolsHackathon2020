import { DEFAULT_TIMEOUT, WEBVIEW_DEFAULT_TIMEOUT } from '../constants';
const SELECTORS = {
    ANDROID: {
...
export function waitForIsDisplayed (selector) {
    selector.waitForDisplayed(DEFAULT_TIMEOUT, false);
}
export function waitForWebviewDisplayed (selector) {
    selector.waitForDisplayed(WEBVIEW_DEFAULT_TIMEOUT, false);
}
